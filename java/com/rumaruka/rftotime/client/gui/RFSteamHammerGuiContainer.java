...
public class RFSteamHammerGuiContainer <TE extends CommonTE, CNT extends CommonContainer> extends GuiContainer {
    public static final int WIDTH = 174;
    public static final int HEIGHT = 186;
    private RFSteamHammerTE te;
    private EntityPlayer player;

    private static ResourceLocation background;
    private static ResourceLocation tempBar;

    public RFSteamHammerGuiContainer(TE tileEntity, CNT container, String bg, EntityPlayer player) {
        super(container);
        this.player = player;
        te = (RFSteamHammerTE) tileEntity;
