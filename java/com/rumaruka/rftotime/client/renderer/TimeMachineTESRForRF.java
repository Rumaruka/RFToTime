...
public class TimeMachineTESRForRF extends TileEntitySpecialRenderer {


    @Override
    public void render(TileEntity tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        TimeMachineTEForRF te = (TimeMachineTEForRF) tileEntity;
    ...
    public void renderCase(TimeMachineTEForRF te, float partialTicks)
    {
        GlStateManager.pushMatrix();
        ...
        IBlockState state = AllBlocks.timeMachine.getDefaultState().withProperty(TimeMachineForRF.IS_CASE_RAISED, true);
    ...
    void renderTimeBattery(TimeMachineTEForRF te, float partialTicks)
    {
