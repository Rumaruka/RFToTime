...
public class RFShardProcessorTESR extends TileEntitySpecialRenderer<RFShardProcessorTE> {


    @Override
    public void render(RFShardProcessorTE tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
    ...
    public void renderFire(RFShardProcessorTE te)
    {
    ...
    void renderItems(RFShardProcessorTE te)
    {
